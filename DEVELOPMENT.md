...
## Code Formatting
Python code should be formatted using [Ruff](https://docs.astral.sh/ruff/). This can be done easily in VS Code by installing the Ruff Formatter extension, setting the Python formatter to Ruff, and running the format document command (Alt+Shift+F).
